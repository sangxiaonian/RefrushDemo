...
public class RefrushLayoutView1 extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public RefrushLayoutView1(Context context) {
        this(context, null);
    }

    public RefrushLayoutView1(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        animationToRefrush = new AnimationToStart()
                ...
                .addIntValues(mCurrentTargetOffsetTop, mSpinnerOffsetEnd)
        ;
