 ...
 * 刷新控件
 */
public class BRefrushView extends BaseRefrushView implements IRefrushView {


    public BRefrushView(Context context) {
        this(context, null, 0);
    }

    public BRefrushView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BRefrushView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void layoutChild(int parentWidth, int parentHeight) {
        ...
        layout((parentWidth / 2 - circleWidth / 2), parentHeight - circleHeight,
                (parentWidth / 2 + circleWidth / 2),parentHeight);
